...
2. Setting up a Hivemind node / installing dependencies
	1. https://raw.githubusercontent.com/bitcoin-hivemind/hivemind/master/doc/fullnode-setup.txt
2. To setup the testing environment and connect to the testnet:
	1. https://github.com/bitcoin-hivemind/testnet-canonical
2. After you have everything setup:
	...
	7. Submit improvements, bugs,  via the Github Issues page of Hivemind. https://github.com/bitcoin-hivemind/hivemind/issues
...
4. (Discuss) Time lock Hivemind market object transactions (Specifically to set the eventOverBy and maturation values), see https://github.com/bitcoin-hivemind/hivemind/issues/28
