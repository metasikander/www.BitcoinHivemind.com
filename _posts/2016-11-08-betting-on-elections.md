...
Believe it or not, [mathematicians discovered long ago, that modern voting (one-person one-vote) doesn't work](http://www.ssc.wisc.edu/~dquint/econ698/lecture%202.pdf).
...
![trump-clinton](http://www.signprofessionals.net/wp-content/uploads/2014/10/Political_yard_sign-e1413299571401.jpg)
...
Politicians tell the most audacious lies. Those of us with even a passable memory find it nothing short of flabbergasting.


---

### 4. (Bonus) Electoral College

Most people are familiar with the following definitions:

"Red States" = Historically, very likely to vote Republican
"Blue States" = Historically, very likely to vote Democratic
"Swing States" = Historitcally, neither Red nor Blue

In Red/Blue states, the outcome is predetermined.

To these, I will try to add the state's relevance:

"Pivotal State" = If this state had voted another way, in any election, they would have changed the outcome.
"Red-Irrelevant" = Always voted Republican, ignoring any non-pivotal votes for Democrat.
"Blue-Irrelevant" = Always voted Democrat, ignoring any non-pivotal votes for Republican.
"Irrelevant States" = Either Red-Irrelevant or Blue-Irrelevant

Simply, most states are 'Irrelevant': the outcome is predetermined, and if it unexpectedly switches (say, from Red to Blue), it *also* doesn't matter, because the (Blue) candidate would have won the election anyway.

I have not calculated how many states are 'Irrelevant' (please comment if you do), but I estimate that it is nearly all of them. Certainly, only 10 states are
...
In general, a political prediction market may be the first prediction market that a layperson has ever encountered. Therefore, [the usual warnings about inherent unpopularity](http://bitcoinhivemind.com/papers/1_Purpose.pdf) apply.
...
( for example, say the election were going to be rigged. the PM would correctly reveal this. )




---- Voting casts a kind of numbness, a kind of "thought novacane". You can't imagine your guy losing, because doubt signals unreliability (or worse, disloyalty).



---- Aiming for the dumbest. We all know the tricks, putting your hands on your opponent to show dominance, repetition of points, going off topic, applause lights. Is it an insult to our intelligence? No, the candidates are aiming for those people.




People see the TV ads, or receive mass-produced placards in their mailbox. It seems fair and just, that they, the citizen, be allowed to intergrate and decide, using their wisdom.
...
sexual misconduct -- you can kill tens of thousands of people, bankrupt the country, persecute groups of people abitrarily. In general, politicians are allowed the full excersize of any malice and cruelty they may possess, and none of it seems to matter to anyone.

By there's one thing that you just can't do. Even uber-charismatic Bill Clinton was almost brought...to his knees.

Why does sexual misconduct move votes (when nothing else does)? I admit that I am mostly mystified by this, but I have a guess.

Laid-ocracy
-------------

Voting Basics: Your vote doesn't count. 


Voters have no skin in the game. Costs are diffused across many individuals.


the marginal cost of a specific vote is free. By this, I mean that, conditional on you casting a vote at all (once you have traveled to the voting booth, and are about to pull the lever).
...
Partially reduces the problem, by reducing scale.
But also,
Greatly exacerbates the problem, by pre-labeling states.

When people ask me who I am voting for. I know they are referring to the Presidency. I tell them that it doesn't matter, because Connecticut is a "blue state" https://en.wikipedia.org/wiki/Red_states_and_blue_states

They get angry at this; it is comparable to someone refusing to choose either Red Sox or Yankees, and instead says that baseball has stupid rules, corrupt referees, terrible players and is an awful game to watch. People invest their identity in their vote -- electing a civil servant 
